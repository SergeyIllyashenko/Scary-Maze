...
{	
	...
	if (lev==2)
	{
		...
		Barriers.push_back(Enemy);
		d_barrier* Enemy1 = new d_barrier(hgeVector(300, 130), g_tEColors,30,150,hgeVector(280, 200));
		Barriers.push_back(Enemy1);
		d_barrier* Enemy2 = new d_barrier(hgeVector(300, 220), g_tEColors,10,120,hgeVector(280, 280));
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	if(hge->System_Initiate())
	{
		...
		gui->AddCtrl(new hgeGUIMenuItem(1,fnt,g_MenueBGMusic,400,200,0.0f,"new game"));
		gui->AddCtrl(new hgeGUIMenuItem(3,fnt,g_MenueBGMusic,400,280,0.2f,"continue game"));
		gui->AddCtrl(new hgeGUIMenuItem(5,fnt,g_MenueBGMusic,400,360,0.4f,"Exit"));
